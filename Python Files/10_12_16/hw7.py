...
#     newPoem = poem.lower()
#     return newPoem
# lowPoem = Lower (cantoXII)


   
# # # def replace(poem):
# # #     newPoem = poem.replace('-', ' ')
# # #     return newPoem
# # # print(replace(cantoXII))


# def splits(poem):
#    SpList = poem.split()
#    return SpList
# splitPoem = splits(lowPoem)

# # # def splits(poem):
# # #     translator = str.maketrans({key: None for key in string.punctuation})
# # #     SpList = poem.translate(translator)
# # #     return SpList
# # # print(splits(cantoXII))
...
#     for key in poem:
#         # print(word)
#         return poem[key],'/',len(splitPoem)

# # print(freq(countWord))
...
#     # (That is a made-up number.) Each function call takes one line.
    ...
    for word in text:
        frequency={}
        frequency[word] = (countWord[word]/len(splitPoem))
        print(frequency)

   
textlist = ["a", "and", "the"]
print("Pablo Frequency: ")
litCricFriend(cantoXII, textlist)

print("Poe Frequency: ")
litCricFriend(theBells, textlist)
...
# print(countWord["and"])
    ...
    # differently?
        ...
        # Pablo and Poe use a & the at different frequencies, but use and very similarly
